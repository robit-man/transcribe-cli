...
category: uat-mcp
argument-hint: <plan_path> [--mode mcp] [--execution-mode quick|standard|full] [--dry-run] [--no-issues] [--resume-from <phase>]
allowed-tools: Read, Write, Bash, Glob, Grep, Edit, Task, mcp__gitea__*
model: opus
---
